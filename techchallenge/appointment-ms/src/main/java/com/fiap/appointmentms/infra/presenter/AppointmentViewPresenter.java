...
public class AppointmentViewPresenter {
    ...
    public static AppointmentView toDomain(AppointmentCorrectionMessage message, LocalDateTime now) {
        return AppointmentView.builder()
                .idAppointment(message.idAppointment())
    ...
    public static AppointmentView toDomain(AppointmentCompletedMessage message, LocalDateTime now) {
        return AppointmentView.builder()
                .idAppointment(message.idAppointment())
    ...
    public static AppointmentView toDomain(AppointmentCancelledMessage message, LocalDateTime now) {
        return AppointmentView.builder()
                .idAppointment(message.idAppointment())
